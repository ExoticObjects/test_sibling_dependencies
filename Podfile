...
# include source for a framework that I'm making (call it POD_A). 
# This should (I think) enable me to list it as a dependency of pod b. 
...
def common_pods_for_target
  ...
  # POD_B - has a dependency on the POD_A framework, but it doesn't work!
...
# # POST INSTALL HOOK - don't know if I need this, but I tried it - doesn't help
